		...
		switch ( $.cookie('tutorial') ) {
			case '1':
				if ( window.location.href.indexOf('index') > -1 ) {
					$('.tutorial').show();
					$('.spotlight').css( { 'top': '-15px', 'left': '-30px', 'width': '105px', 'height': '105px', 'animation-name': 'to-menu', 'animation-duration': '3s' } );
			...
			case '3':
				if ( window.location.href.indexOf('camomila-alema-azul') > -1 ) {
					setTimeout( function() {
						$('.tutorial').show();
						$('.spotlight').css( { 'top' : '390px', 'left': '-10px', 'width': '105px', 'height': '105px', 'animation-name': 'to-form-of-use', 'animation-duration': '13s' } );
						$('.spotlight-effect').css( { 'animation-name': 'none', 'border-radius': '1%' } );
						...
						$('.spotlight').click( function() {
							...
							$('.spotlight').css( { 'top' : 'calc(100% - 85px)', 'left': 'calc(50% - 53px)', 'width': '105px', 'height': '105px', 'animation-name': 'to-form-of-use-bottom', 'animation-duration': '2s' } );
							$('.spotlight-effect').css( { 'animation-name': 'none', 'border-radius': '50%' } );
							$('.spotlight-effect').css( { 'animation-name': 'to-form-of-use-bottom-ripple', 'animation-delay': '2s' } );
							$('.spotlight').click( function() {
								$('.spotlight').unbind('click');
								$('.close-bottom-notification').click();
								$('.spotlight').css( { 'top' : '-21px', 'left': 'calc(50% - 89px)', 'width': '180px', 'height': '105px', 'animation-name': 'to-search', 'animation-duration': '2s' } );
								$('.spotlight-effect').css( { 'animation-name': 'none', 'border-radius': '50%' } );
