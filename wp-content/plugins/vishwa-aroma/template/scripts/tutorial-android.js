	...
	if ( $.cookie('tutorial') != '' ) {
		switch ( $.cookie('tutorial') ) {
			...
			if ( window.location.href.indexOf('menu-oleo-essencial') > -1 ) {
					$('.tutorial').show();
					$('.spotlight').css( { 'top' : '204px', 'left': 'calc(100% - 80px)', 'width': '105px', 'height': '105px', 'border-radius': '50%', 'animation-name': 'to-menu-index', 'animation-duration': '4s' } );
					...
					$('.spotlight').click( function() {
						$('.spotlight').unbind('click');
						$('a[href="#c"]').click();
						$('.spotlight').css( { 'top' : '300px', 'left': '48px', 'width': 'calc(100% - 90px)', 'height': '80px', 'border-radius': '1%', 'animation-name': 'to-menu-index-letter', 'animation-duration': '4s' } );
			...
			case '3':
				if ( window.location.href.indexOf('camomila-alema-azul') > -1 ) {
					setTimeout( function() {
						$('.tutorial').show();
						$('.spotlight').css( { 'top' : '397px', 'left': '-10px', 'width': '105px', 'height': '105px', 'animation-name': 'to-form-of-use', 'animation-duration': '13s' } );
						$('.spotlight-effect').css( { 'animation-name': 'none', 'border-radius': '1%' } );
